...
class Dice2Loss(nn.Module):
    ...
    def forward(self, y_pr, y_gt):
        return 1 - F.f_score2(y_pr, y_gt, threshold=None, activation=self.activation)
...
class BCEDice2Loss(Dice2Loss):
    __name__ = 'bce_dice2_loss'

    def __init__(self, activation='sigmoid', dice_bce_ratio=(1, 1)):
