...
def drn_a_50(BatchNorm=nn.BatchNorm2d, pretrained=True):
...
def drn_c_26(BatchNorm=nn.BatchNorm2d, pretrained=True):
...
def drn_c_42(BatchNorm=nn.BatchNorm2d, pretrained=True):
...
def drn_c_58(BatchNorm=nn.BatchNorm2d, pretrained=True):
...
def drn_d_22(BatchNorm=nn.BatchNorm2d, pretrained=True):
...
def drn_d_24(BatchNorm=nn.BatchNorm2d, pretrained=True):
...
def drn_d_38(BatchNorm=nn.BatchNorm2d, pretrained=True):
...
def drn_d_40(BatchNorm=nn.BatchNorm2d, pretrained=True):
...
def drn_d_54(BatchNorm=nn.BatchNorm2d, pretrained=True):
...
def drn_d_105(BatchNorm=nn.BatchNorm2d, pretrained=True):
